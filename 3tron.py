    ...
    for state in states:
            ...
            if 'attract_mode_on' in state:
                if not flags['attract']:
                    ...
                    result = subprocess.check_output(['omxd', 'a', '/home/pi/media/attract/Z-Tron-Legacy.mp4'])
                    logger.debug(result)
		    ...
		    result = subprocess.check_output(['omxd', 'X'])
		    logger.debug(result)
		    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/recognizer/B-recognizer-hit.mp4'])
		    logger.debug(result)
		    ...
		    logger.debug(result)
                ...
                if not flags['clu_lit']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/clu/clu_lit.mp4'])
                    logger.debug(result)
                    flags['clu_lit'] = True
                ...
                if not flags['clu_complete']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/clu/clu_complete.mp4'])
                    logger.debug(result)
                ...
                if not flags['discmb_complete']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/discmb/discmb_complete.mp4'])
                    logger.debug(result)
                ...
                if not flags['tron_active']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/tron/tron_active.mp4'])
                    logger.debug(result)
                ...
                if not flags['tron_complete']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/tron/tron_complete.mp4'])
                    logger.debug(result)
                ...
                if not flags['gem_complete']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/gem/gem_complete.mp4'])
                    logger.debug(result)
                ...
                if not flags['zuse_complete']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/zuse/zuse_complete.mp4'])
                    logger.debug(result)
                ...
                if not flags['lcmb_complete']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/lcmb/lcmb_complete.mp4'])
                    logger.debug(result)
                ...
                if not flags['qmb_lit']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/qmb/qmb_lit.mp4'])
                    logger.debug(result)
                    flags['qmb_lit'] = True
                ...
                if not flags['qmb_complete']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/qmb/qmb_complete.mp4'])
                    logger.debug(result)
                ...
                if not flags['sos_lit']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/sos/sos_lit.mp4'])
                    logger.debug(result)
                    flags['sos_lit'] = True
                ...
                if not flags['sos_complete']:
                    result = subprocess.check_output(['omxd', 'X'])
                    logger.debug(result)
                    result = subprocess.check_output(['omxd', 'A', '/home/pi/media/sos/sos_complete.mp4'])
                    logger.debug(result)
